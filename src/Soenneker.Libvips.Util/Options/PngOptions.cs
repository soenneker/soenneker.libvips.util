...
public sealed class PngOptions : LibvipsOptions
{
    ...
    public override void Validate()
    {
        ...
        if (Compression is < 0 or > 9) throw new System.ArgumentOutOfRangeException(nameof(Compression));
        if (Quality is < 0 or > 100) throw new System.ArgumentOutOfRangeException(nameof(Quality));
        if (!double.IsFinite(Dither) || Dither is < 0 or > 1) throw new System.ArgumentOutOfRangeException(nameof(Dither));
        if (BitDepth is not (1 or 2 or 4 or 8 or 16)) throw new System.ArgumentOutOfRangeException(nameof(BitDepth));
        if (QuantizationEffort is < 1 or > 10) throw new System.ArgumentOutOfRangeException(nameof(QuantizationEffort));
    }
}
