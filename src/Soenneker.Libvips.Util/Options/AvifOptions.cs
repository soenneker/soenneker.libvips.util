...
public sealed class AvifOptions : LibvipsOptions
{
    ...
    public override void Validate()
    {
        ...
        if (Quality is < 1 or > 100) throw new System.ArgumentOutOfRangeException(nameof(Quality), "AVIF quality must be between 1 and 100.");
        if (Effort is < 0 or > 9) throw new System.ArgumentOutOfRangeException(nameof(Effort));
        if (BitDepth is < 8 or > 12) throw new System.ArgumentOutOfRangeException(nameof(BitDepth));
    }
}
